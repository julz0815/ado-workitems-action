...
/**
 * Extracting Static and Dynamic flaw data and composing work item data
 */
interface FlawParameters {
    workItem: CommonData.WorkItemDto;
    veracodeLinks: string;
    cweDetails: string;
    flawModule: string;
    flawSource: string;
    attackVector: string;
    currentFlawURL: string;
...
interface CategoryParameters {
    categoryDetails: CommonData.CategoryDetailedReportDto;
    currentCategoryListItem: any;
...
export class StaticAndDynamicFlawManager {
    ...
    */
    public captureDASTAndSASTFlawData(xmlDoc: XMLDocument, workItemDetails: CommonData.workItemsDataDto, scanDetails: CommonData.ScanDto, importParameters: CommonData.FlawImporterParametersDto) {
    ...
    private populateSeverityData(
        severityListItem: any,
        scanDetails: CommonData.ScanDto,
        importParameters: CommonData.FlawImporterParametersDto,
        workItemsCreationData: CommonData.workItemsDataDto): CommonData.SeverityDetailedReportDto {
    ...
    private populateCategoryData(
        { categoryDetails, currentCategoryListItem, sevData, scanDetails, importParameters, workItemsCreationData }: CategoryParameters) {
     ...
     */
    private getRecommendationParagraphText(paraList: any, catRecomendation: CommonData.CategoryRecomendationsDetailedReportDto): CommonData.CategoryRecomendationsDetailedReportDto {
     ...
     */
    private getMainParagraphText(paraList: any, catDescription: CommonData.CategoryDescriptionDetailedReportDto): CommonData.CategoryDescriptionDetailedReportDto {
    ...
    private populateCweData(
        ...
        scanDetails: CommonData.ScanDto,
        importParameters: CommonData.FlawImporterParametersDto,
        workItemsCreationData: CommonData.workItemsDataDto): CommonData.cweDto {
    ...
    private populateDynamicFlawData(dynamicFlaws: any, cweListItem: any, cweDetails: CommonData.cweDto, catData: CommonData.CategoryDetailedReportDto, sevData: CommonData.SeverityDetailedReportDto, scanDetails: CommonData.ScanDto, importParameters: CommonData.FlawImporterParametersDto, workItemsCreationData: CommonData.workItemsDataDto) {
    ...
    private populateStaticFlawData(cweStaticFlaws: any, cweListItem: any, cweDetails: CommonData.cweDto, catData: CommonData.CategoryDetailedReportDto, sevData: CommonData.SeverityDetailedReportDto, scanDetails: CommonData.ScanDto, importParameters: CommonData.FlawImporterParametersDto, workItemsCreationData: CommonData.workItemsDataDto) {
     ...
     */
    private populateFlawAnnotationData(flaw: any, commentsList: Array<CommonData.CommentsDTO>): void {
     ...
     * @param commentsList - flaw comments list
     */
    private populateFlawMitigationData(flaw: any, commentsList: Array<CommonData.CommentsDTO>): void {
     ...
     */
    private composeWorkItemComments(flawData: CommonData.FlawDto): string {
    ...
    */
    ...
    private adjustWorkItemDataByType(
        ...
        let cweLink, flawURL, veracodeLinks, flawCweDetails, flawModule, flawSource, attackVector, currentFlawDesc, flawReferences, currentFlawURL, dynamicParameter, wascLinkExtractedFromFlawDescription, formattedWASCLINK, sandboxNameForTitle: string, gracePeriodExpires;
        ...
        if (flawData.FlawType == CommonData.Constants.flawType_Static) {
            ...
            this.generateWorkItemTitle(workItem,
                sandboxNameForTitle,
                CommonData.Constants.staticFlawWorkItem_TitlePrefix,
                catData.CategoryName,
                importParameters.VeracodeAppProfile,
                flawData.IssueID.toString());
            ...
            this.generateWorkItemTitle(workItem,
                sandboxNameForTitle,
                CommonData.Constants.dynamicFlawWorkItem_TitlePrefix,
                catData.CategoryName,
                importParameters.VeracodeAppProfile,
                flawData.IssueID.toString());
            veracodeLinks = `<b> Veracode Links : </b> <a href=${scanDetails.ResultPageURL}>Application</a>
    ...
    private generateWorkItemBody(
        { workItem, veracodeLinks, cweDetails, flawModule, flawSource, attackVector, currentFlawURL, dynamicParameter, flawDesc, references, gracePeriodExpires }: FlawParameters) {
    ...
    * @param flaw - flaw that contains annotation data
    */
    private populateFlawComments(flaw: any): Array<CommonData.CommentsDTO> {

        core.debug("Class Name: StaticAndDynamicFlawManager, Method Name: populateFlawComments");
        try {
            let commentsList = new Array<CommonData.CommentsDTO>();
            ...
            if (commentsList.length > 0) {
                commentsList.sort(function (a, b) {
                    let c: Date = new Date(a.Date);
                    let d: Date = new Date(b.Date);
                    return c > d ? 1 : -1;
                });
            }
            return commentsList;
     ...
     */
    private formatDueDate(gracePeriodExpires: string): string {
